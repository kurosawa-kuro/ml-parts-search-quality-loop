...
class Settings:
    ...
    def blockers(self, stage: str) -> list[str]:
        ...
        required = {
            ...
            "simulation": [
                "simulation.policyId",
                # 版と確率が埋まるまで simulation を開始しない（05）。
                "simulation.policyVersion",
                "simulation.sessionsPerQuery",
                "simulation.positionBias.model",
                "simulation.positionBias.decay",
                "simulation.clickProbability.relevant",
                "simulation.clickProbability.marginal",
                "simulation.clickProbability.irrelevant",
                "simulation.conversionProbabilityGivenClick",
                "simulation.reformulationProbability.zeroResult",
                "simulation.reformulationProbability.noClick",
                "simulation.reformulationProbability.afterClick",
                "simulation.lateInteractionSeconds",
                "simulation.seed",
