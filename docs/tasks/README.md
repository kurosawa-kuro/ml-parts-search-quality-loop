...
| ファイル | 用途 |
|---|---|
| [全体実装計画](03_active/20260921-search-quality-poc-implementation.md) | T1/T2完了、次はT3。全体は未完了 |
...
次に着手する機能は [T3](02_backlog/2026-09-22-VectorBaseline検索とSearchRun.md)。
現時点の`03_active`には全体計画と常設の整理候補だけを置く。T1は基盤完了・fixture残件移管、T2は大規模検証まで完了として`05_done`へ整理済み。T3〜T8は未実装なのでbacklogに保持する。
...
- [T6 Experiment比較と品質Gate](02_backlog/2026-09-22-Experiment比較と品質Gate.md)
